...
def IK_velocity(q_in, v_in, omega_in, joint):
    """
    ...
    :param omega: The desired angular velocity in the world frame. If any element is Nan, then that velocity can be
                  anything
    :param joint: an integer in [0,7] corresponding to which joint you are tracking
    :return:
    dq - 0 x 7 vector corresponding to the joint velocities. If v and omega
         are infeasible, then dq should minimize the least squares error. If v and omega have multiple solutions then
         you should minimize the l2 norm of dq
    """
